...
use App\Periodic;
use App\Transaction;
class everyyears extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'every:year';
     ...
     * @var string
     */
    protected $description = 'Periodic Transaction: Yearly';
    ...
    public function handle()
    {
        ...
        $amount = array();
        $i=0;
        $data = Periodic::where('duration',4)->get();
        foreach ($data as $da){
            $tags[$i] = $da->tags;
        ...
        for($i=0;$i<count($data);$i++){
            ...
            $tran->description = "Periodic Transaction after every year";
            $tran->tags = $tags[$i];
