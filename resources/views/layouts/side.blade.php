...
<div style="margin-top:50px; background-color:#660033;">
<div class="col-md-3" style="background-color:#660033; height: auto;">
<div id="img">
<img src="<?php echo Session::get('img_url');?>" class="img-responsive" width="304" height="236">
</div>
<center>
...
<a href="/account_account_transfer"><li><button id="snav" class="btn btn-primary"><span class="glyphicon glyphicon-transfer"></span> Account to Account Transfer</button></li></a>
